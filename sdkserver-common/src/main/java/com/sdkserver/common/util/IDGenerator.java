...
//            public void run() {
//                for(int i=0; i<500; i++){
//                    long generator = IDGenerator.getInstance().nextOrderID();
//                    if(lst.contains(generator)){
//                        System.out.println("duplicated generator:"+generator+"; bcode:"+Long.toBinaryString(generator));
//
//                    }else{
//                        lst.add(generator);
//                    }
