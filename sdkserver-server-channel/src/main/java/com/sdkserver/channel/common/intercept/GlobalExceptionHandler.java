package com.sdkserver.channel.common.intercept;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    //@ResponseStatus(HttpStatus.BAD_REQUEST) //设置返回response状态
    public Result nullObjectHandle() {

        return Result.info(ErrCode.EMPTY_OBJECT.toJson());
    }

    @ExceptionHandler(NullFindKindException.class)
    @ResponseBody
    //@ResponseStatus(HttpStatus.BAD_REQUEST) //设置返回response状态
    public Result nullFindKindHandle(NullFindKindException e) {

        return Result.info(ErrCode.NO_FIND_KIND.toJson());
    }

    @ExceptionHandler(ExistObjectException.class)
    @ResponseBody
    //@ResponseStatus(HttpStatus.BAD_REQUEST) //设置返回response状态
    public Result existKindHandle(ExistObjectException e) {

        return Result.info(ErrCode.EXIST_OBJECT.toJson());
    }
}
